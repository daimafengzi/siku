...
================Loon==============
[Script]
cron "54 59 7,9,11,13,15 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, tag=京东极速版9.9减5优惠券

 */
const $ = new Env('京东极速版9.9减5优惠券');
      ...
      try {
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            console.log(`【京东极速版9.9减5优惠券】${JSON.stringify(data.subCodeMsg)}\n`);
			//自行添加通知项目开始
