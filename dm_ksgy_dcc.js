...
[Script]
cron "4 0 * * *" script-path=https://github.com/daimafengzi/siku.git, tag=快手内部助力dcc
*/
const $ = new Env('快手内部助力dcc')
let cookieArr = [];
...
function  officialSign() {
   return new Promise((resolve, reject) => {
	 let signurl = {
		url: 'https://cdn.daimafengzi.com/ksdcc.json',
   }
...
function  officialSignhf() {
   return new Promise((resolve, reject) => {
	 let signurl = {
        ...
        body: '{"fid":"'+fid+'","cc":"share_copylink","followRefer":"151","shareMethod":"TOKEN","sharePosition":"MANURE_AID_INVITE_BUTTON","kpn":"NEBULA","subBiz":"OD_MANURE_SHARE","source":"PASSPHRASE_BACK","shareMode":"APP","enableWK":"1","layoutType":"4","shareObjectId":"'+shareObjectId+'","shareUrlOpened":"0","hyId":"orchard","timestamp":"'+Date.now()+'"}'
   }
