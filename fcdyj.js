...
function getAuthorShareCode() {
    return new Promise(resolve => {
        $.get({
            url: "https://cdn.jsdelivr.net/gh/daimafengzi/shareCodes/dyj.json",
            headers: {
...
function taskUrl(function_id, body) {
    return {
        ...
        headers: {
            ...
            "Host": "api.m.jd.com",
            "Referer": "https://618redpacket.jd.com/?activityId=PFbUR7wtwUcQ860Sn8WRfw&channel=wjicon&sid=0a1ec8fa2455796af69028f8410996aw&un_area=1_2803_2829_0",
            "Cookie": cookie,
