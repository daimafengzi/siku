...
[task_local]
#京东极速版领红包
21 3,8,13,20,23 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, tag=京东极速版领红包, img-url=https://raw.githubusercontent.com/Orz-3/task/master/jd.png, enabled=true

================Loon==============
[Script]
cron "21 3,8,13,20,23 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js,tag=京东极速版领红包

===============Surge=================
京东极速版领红包 = type=cron,cronexp="21 3,8,13,20,23 * * *",wake-system=1,timeout=33600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js

============小火箭=========
京东极速版领红包 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_speed_sign.js, cronexpr="21 3,8,13,20,23 * * *", timeout=33600, enable=true
*/
const $ = new Env('京东极速版领红包');
...
async function signInit() {
  return new Promise(resolve => {
    $.get(taskUrl('speedSignInit', {
      "activityId": "6bf9310b29d14aaca4ceaf6b15bb35a6",
      "kernelPlatform": "RN",
