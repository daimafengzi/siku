...
水滴助力码变量KS_SHARECODE
[Script]
cron "3 0 * * *" script-path=https://github.com/daimafengzi/siku.git, tag=快手内部助力al
*/
const $ = new Env('快手内部助力al')
let cookieArr = [];
let KS_SHARECODEArr = [],message, allMessage = '',shareId='';
