...
function  officialSign() {
   return new Promise((resolve, reject) => {
	 let signurl = {
        ...
        body: '{"fid":"2681542910","cc":"share_copylink","followRefer":"151","shareMethod":"TOKEN","sharePosition":"MANURE_AID_INVITE_BUTTON","kpn":"NEBULA","subBiz":"OD_MANURE_SHARE","shareId":"16784680006611","source":"PASSPHRASE_BACK","shareMode":"APP","originShareId":"16784680006611","enableWK":"1","layoutType":"4","shareObjectId":"3xrzrkn7259858u","shareUrlOpened":"0","hyId":"orchard","timestamp":"'+Date.now()+'"}'
   }
...
function  officialSign2() {
   return new Promise((resolve, reject) => {
	 let signurl = {
		url: 'https://ug-fission.kuaishou.com/rest/n/darwin/orchard/overview',
	    headers: {Cookie: cookieVal.replace('kpn=NEBULA', 'kpn=KUAISHOU'),'Content-Type': 'application/json;charset=utf-8'},
        body: '{"fid":"2681542910","cc":"share_copylink","followRefer":"151","shareMethod":"TOKEN","sharePosition":"WATER_AID_INVITE_BUTTON","kpn":"NEBULA","subBiz":"OD_WATER_SHARE","shareId":"16784654095495","source":"PASSPHRASE_BACK","shareMode":"APP","originShareId":"16784654095495","enableWK":"1","layoutType":"4","shareObjectId":"3xrzrkn7259858u","shareUrlOpened":"0","hyId":"orchard","timestamp":"'+Date.now()+'"}'
   }
    $.post(signurl, (error, response, data) => {
		console.log(data);
		//console.log("水滴助力");
