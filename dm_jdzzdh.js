...
================Loon==============
[Script]
cron "3 0 8 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_price.js,tag=京东赚赚兑换红包

 */
const $ = new Env('京东赚赚兑换红包');
...
async function jstoken() {
	return new Promise(async resolve => {
		const options = {
			"url": `https://api.m.jd.com/client.action?functionIdTest=exchangePrize`,
			"headers": {
    ...
    body: 'functionId=exchangePrize&body={"prizeId":3}&client=wh5&clientVersion=1.0.0&loginType=1&loginWQBiz=returnMoney'
		}
