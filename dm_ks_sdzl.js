...
[Script]
cron "0 18,19,20,21,22,23 * * *" script-path=https://github.com/daimafengzi/siku.git, tag=快手果园水滴助力
*/
const $ = new Env('快手果园水滴助力')
let cookieArr = [];
...
'Content-Type': 'application/json;charset=utf-8'},
		  body: '{"fid":"'+fid+'","cc":"panelPoster","followRefer":"151","shareMethod":"PICTURE","sharePosition":"WATER_AID_INVITE_BUTTON","kpn":"NEBULA","subBiz":"OD_WATER_SHARE","shareId":"16705608129698","source":"PASSPHRASE_BACK","shareMode":"APP","originShareId":"16705608129698","enableWK":"1","layoutType":"4","shareObjectId":"'+shareObjectId+'","shareUrlOpened":"0","hyId":"orchard","timestamp":"'+Date.now()+'"}'
   }
