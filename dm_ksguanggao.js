...
建议cron: 0 0 * * *  
[Script]
cron "30 0 * * *" script-path=https://raw.githubusercontent.com/daimafengzi.js,tag=快手果园广告

*/
const logs = false   //日志开关
const $ = new Env('快手果园广告')
let cookieArr = [];
